...
import MaterialIcons from '@expo/vector-icons/MaterialIcons'; // Import MaterialIcons from @expo/vector-icons
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        {[
          ...
          { icon: 'design-services', label: 'Customize' }, // Changed icon to 'design-services'
        ].map((item, index) => (
          <TouchableOpacity
            key={index}
            ...
            onPress={() => {
              ...
              } else if (item.label === 'Customize') {
                navigation.navigate('ArtisanList'); // Navigate to CustomizeScreen
              }
            }}
          >
            <MaterialIcons name={item.icon} size={24} color={colors.primary} /> {/* Use MaterialIcons for the Customize icon */}
